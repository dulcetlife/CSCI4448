...
$query = "SELECT repo_name, username, language, readme FROM repos WHERE repo_name LIKE '%$keyword%' OR username LIKE '%$keyword%' OR readme LIKE '%$keyword%' AND language = 'javascript'";
