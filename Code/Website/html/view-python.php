...
$.ajax({
type: "GET",
url: "ajax-search.php?language=python",
data: dataString,
 ...
 $("input#faq_search_input").removeClass("loading");
	...
	<body>
      ...
      <div class="prod-subsubhead">
      	<central>
        <h4 id="faq_title"> <strong>Search: </strong> <span id="faq_category_title"> </span> </h4>      </div>
      <div class="prod-subcontent">
        <div class="prod-lcol fl-left">
          <div class="prod-content">
            ...
            <div id="searchresultdata" class="faq-articles" style="align:center"> </div>
          </div>
        </div>
